...
const emptyMessage =
  'This is empty.  You currently have no dog ears saved.  Start dog earing tabs using the button on the top right of your browser.';
const emptyOpenTabs =
  'This is empty.  You currently have no dog ears saved.  Start by dog earing some of your open tabs.  Click the icons to select.';
...
class Guide extends React.Component {
  ...
  render() {
    ...
    return <div className="guide">{contents}</div>;
  }
}
